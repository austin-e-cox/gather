...
function InputArea({userName, socket }) {
  ...
  return (
    ...
    <div className="input_msg_write">
      <input type="text" className="write_msg" placeholder="Please type here" value={message} onChange={handleMessageChange} onSubmit={handleSubmit} onKeyPress={handleKeyPress}/>
